                                ...
                                <div className="col-md-9 col-sm-8 col-xs-12">
                                    ...
                                    <div className="product-box">
                                        <div className="product-box-row">
                                            {/* {productCatItemList.filter((item, i) => {
                                                // {(item.category == pCategory)  };
                                                // alert(item.category === pCategory);
                                                 console.log("Check Cat Match", item.category, pCategory)
                                                 console.log("f", item.category == pCategory);
                                                 return(
                                                            ...
                                                            <div className="product-title">
                                                                ...
                                                                {(this.state.cartCount == 0) ?
                                                                    ...
                                                                    <div className="counter-box">
                                                                        ...
                                                                        <button className="btn btn-white" onClick={this.addToCart}>+</button>
                                                                    </div>
